...
public class CreateBSTBasedOnArray {
	...
	Node constructTree(int pre[], int size) {
		...
		for (int i = 1; i < size; ++i) {
			...
			/*
			 * Keep on popping while the next value is greater than stack's top
			 * value.
			 */
	...
	public static void main(String[] args) {
		CreateBSTBasedOnArray tree = new CreateBSTBasedOnArray();
