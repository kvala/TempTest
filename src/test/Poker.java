...
public class Poker {
	...
	/*
	 * ----------------------------------------------------- valueStraight(): return
	 * value of a Straight hand
	 * 
	...
	/*
	 * --------------------------------------------------------- valueFourOfAKind():
	 * return value of a 4 of a kind hand
	 * 
	 * value = FOUR_OF_A_KIND + 4sCardRank
	 * 
	 * Trick: card h[2] is always a card that is part of the 4-of-a-kind hand There
	 * is ONLY ONE hand with a quads of a given rank.
	 * ---------------------------------------------------------
	 */
	...
	/*
	 * ----------------------------------------------------------- valueFullHouse():
	 * return value of a Full House hand
	 * 
	 * value = FULL_HOUSE + SetCardRank
	 * 
	 * Trick: card h[2] is always a card that is part of the 3-of-a-kind in the full
	 * house hand There is ONLY ONE hand with a FH of a given set.
	 * -----------------------------------------------------------
	 */
	...
	/*
	 * --------------------------------------------------------------- valueSet():
	 * return value of a Set hand
	 * 
	 * value = SET + SetCardRank
	 * 
	 * Trick: card h[2] is always a card that is part of the set hand There is ONLY
	 * ONE hand with a set of a given rank.
	 * ---------------------------------------------------------------
	 */
	...
	/*
	 * ----------------------------------------------------- valueTwoPairs(): return
	 * value of a Two-Pairs hand
	 * 
	...
	public static int valueTwoPairs(Card[] h) {
		...
		if (h[0].rank() == h[1].rank() && h[2].rank() == h[3].rank())
			val = 14 * 14 * h[2].rank() + 14 * h[0].rank() + h[4].rank();
		else if (h[0].rank() == h[1].rank() && h[3].rank() == h[4].rank())
	...
	/*
	 * ----------------------------------------------------- valueOnePair(): return
	 * value of a One-Pair hand
	 * 
	 * value = ONE_PAIR + 14^3*PairCard + 14^2*HighestCard + 14*MiddleCard +
	 * LowestCard -----------------------------------------------------
	 */
	public static int valueOnePair(Card[] h) {
		...
		if (h[0].rank() == h[1].rank())
			val = 14 * 14 * 14 * h[0].rank() + +h[2].rank() + 14 * h[3].rank() + 14 * 14 * h[4].rank();
		else if (h[1].rank() == h[2].rank())
			val = 14 * 14 * 14 * h[1].rank() + +h[0].rank() + 14 * h[3].rank() + 14 * 14 * h[4].rank();
		else if (h[2].rank() == h[3].rank())
			val = 14 * 14 * 14 * h[2].rank() + +h[0].rank() + 14 * h[1].rank() + 14 * 14 * h[4].rank();
		else
			val = 14 * 14 * 14 * h[3].rank() + +h[0].rank() + 14 * h[1].rank() + 14 * 14 * h[2].rank();
	...
	public static int valueHighCard(Card[] h) {
		...
		val = h[0].rank() + 14 * h[1].rank() + 14 * 14 * h[2].rank() + 14 * 14 * 14 * h[3].rank()
				+ 14 * 14 * 14 * 14 * h[4].rank();
	...
	public static boolean isFullHouse(Card[] h) {
		...
		a1 = h[0].rank() == h[1].rank() && // x x x y y
				h[1].rank() == h[2].rank() && h[3].rank() == h[4].rank();

		a2 = h[0].rank() == h[1].rank() && // x x y y y
				h[2].rank() == h[3].rank() && h[3].rank() == h[4].rank();
	...
	public static boolean is3s(Card[] h) {
		...
		a1 = h[0].rank() == h[1].rank() && h[1].rank() == h[2].rank();

		a2 = h[1].rank() == h[2].rank() && h[2].rank() == h[3].rank();

		a3 = h[2].rank() == h[3].rank() && h[3].rank() == h[4].rank();
	...
	public static boolean is22s(Card[] h) {
		...
		a1 = h[0].rank() == h[1].rank() && h[2].rank() == h[3].rank();

		a2 = h[0].rank() == h[1].rank() && h[3].rank() == h[4].rank();

		a3 = h[1].rank() == h[2].rank() && h[3].rank() == h[4].rank();
